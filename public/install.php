...
//mysql的账户相关
    ...
    //检测能否读取安装文件
    $sql = @file_get_contents(WWW_ROOT . DS . "" . DS . 'database.sql');
    if (!$sql) {
        throw new Exception("无法读取/public/database.sql文件，请检查是否有读权限");
    }
    //替换表前缀
    ...
    <div class="layui-row">
        <div class="layui-col-md4 layui-col-md-offset4" >
            ...
            <div class="footer">
                ...
                <h6>版权所有 2019-2021 © <a href="https://www.gacjie.cn/" target="_blank">筱杰小栈</a></h6>
            </div>
        </div>
